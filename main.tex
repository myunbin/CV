...
\resumeSubHeadingListStart
    \resumeProject
      {shake! - \href{https://www.acmicpc.net/category/detail/3557}{2022}, 2023} %Project Name
      {Director, Problem setter} %Project Name, Location Name
      {Oct '23 - Current} %Event Dates
      {\textit{Dec '22 - Mar '23}} %Event Dates
    ...
    \resumeItemListStart
        ...
        \begin{itemize}
            \item Participants : Ajou, Hanyang-ERICA, Inha, Korea Aerospace, Kyunghee, Sungkyunkwan Univ.
        \end{itemize}
        \item {Designed set of problems}
        \begin{itemize}
            \item {2022 : Submitted 2 problems (Problem B, C)}
            \item {2023 : Submitted 2 problems (Problem ??)}
        \end{itemize}
    \resumeItemListEnd
    \vspace{-2mm}

    \resumeProject
      {Ajou Programming Contest (APC) - \href{https://www.acmicpc.net/category/detail/3219}{2022}, \href{https://www.acmicpc.net/category/848}{2023}} %Project Name
      {Director, Problem setter} %Project Name, Location Name
      {Mar '23 - May '23} %Event Dates
      {\textit{Sep '23 - Nov '22}} %Event Dates

    \resumeItemListStart
        \item {Annual ICPC-style programming contest held in Ajou Univ.}
        \item {Problem submissions}
        \begin{itemize}
            \item {2022 : Submitted 3 problems (Problem D, H, J)}
            \item {2023 : Submitted 7 problems (Problem C, E, G, H, J for Advanced division, C, H for Beginner's division)}
        \end{itemize}
    \resumeItemListEnd
    \vspace{-2mm}
    ...
    \resumeItemListStart
        ...
        \item {Ran algorithmic problem solving study group}
...
\resumePOR{Theory of Computation} % Position
    {} %Club,Event
    {} %Tenure Period

\resumePOR{Computer System Software} % Position
    {} %Club,Event
    {} %Tenure Period
\resumeSubHeadingListEnd
...
\resumePOR{34th place, } % Award
    {2023 International Collegiate Programming Contest (ICPC) - Seoul Regional} % Event
    {Nov '23} %Event Year

\resumePOR{59th place, } % Award
    {2022 International Collegiate Programming Contest (ICPC) - Seoul Regional} % Event
    {Nov '22} %Event Year
    
\resumePOR{Finalist, } % Award
    {2023 Samsung Collegiate Programming Cup (SCPC)} % Event
    {Aug '23} %Event Year

\resumePOR{Academic Scholarship} % Award
