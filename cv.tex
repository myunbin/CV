...
\resumePOR{Compiler Optimizations, Programming Languages, Algorithms} % Position
{} %Club,Event
{} %Tenure Period
...
\item \textit{Distinguished Graduate Award(아주인상)}, recognized for distinguished external achievements
\resumeItemListEnd
\resumeSubHeadingListEnd
% \vspace{-5.5mm}
%
...
\resumeProject
{\href{https://ansi.ajou.club/}{Analyze 'N Solve It (ANSI)}} %Project Name
...
\resumePOR{Department Valedictorian(Computer Engineering), }
{Ajou University}
{Feb '26}

\resumePOR{Distinguished Graduate Award(아주인상), }
{Ajou University}
{Feb '26}
...
{2025 ICPC Yokohama Regional} % Event
{Nov '25} %Event Year
